...
names(seer)<-c("garde","tumor_size","lymph_nodes","surging","surg_rad","Chemotherapy","Systemic_treatment","maritalstatus",
               ...
               "lobe","vascular_invasion","AFP","Fibrosis_score")
...
seer_autoscor<-select(seer_autoscor,c(1:14,16:22),"label")




for(i in names(seer_autoscor)[1:21]){seer_autoscor[,i]<-as.numeric(seer_autoscor[,i])}
str(seer_autoscor)
...
myvars<-c("garde", "tumor_size", "lymph_nodes", "surging", "surg_rad", 
          ...
          "nodules", "lobe", "vascular_invasion", "AFP", "Fibrosis_score", 
          "label")
